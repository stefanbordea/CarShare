...
<body id="termsBody">
    ...
    <h2 id="termsHeader"><strong>Terms and Conditions</strong></h2>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="termsNavbar">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#Hyperlink">Hyperlinks to
                            our content</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#iFrames">iFrames</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#ContentLiability">Content
                            Liability</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Privacy">Your Privacy
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Disclaimer">Disclaimer
                        </a>
                    </li>
    ...
    <p>These terms and conditions outline the rules and regulations for the use of DynamicWebApplication's Website,
        located at www.dynamicwebapplication.com.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
        DynamicWebApplication.com if you do not agree to take all of the terms and conditions stated on this page.</p>
    ...
    <p>We employ the use of cookies. By accessing DynamicWebApplication.com, you agreed to use cookies in agreement with
        the DynamicWebApplication's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, DynamicWebApplication and/or its licensors own the intellectual property rights for all
        material on DynamicWebApplication.com. All intellectual property rights are reserved. You may access this from
        DynamicWebApplication.com for your own personal use subjected to restrictions set in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from DynamicWebApplication.com</li>
        <li>Sell, rent or sub-license material from DynamicWebApplication.com</li>
        <li>Reproduce, duplicate or copy material from DynamicWebApplication.com</li>
        <li>Redistribute content from DynamicWebApplication.com</li>
    </ul>

    <p>This Agreement shall begin on the date hereof. </p>

    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. DynamicWebApplication does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions of DynamicWebApplication,its agents
        and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, DynamicWebApplication shall not be liable for the Comments or for any
    ...
    <p>DynamicWebApplication reserves the right to monitor all Comments and to remove any Comments which can be
    ...
    <p>You hereby grant DynamicWebApplication a non-exclusive license to use, reproduce, edit and authorize others to
        use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
    <br>
    <h3 id="Hyperlink"><strong>Hyperlinking to our Content</strong></h3>
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
    ...
    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of
    DynamicWebApplication; and (d) the link is in the context of general resource information.</p>
...
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
    must inform us by sending an e-mail to DynamicWebApplication. Please include your name, your organization name,
...
<p>No use of DynamicWebApplication's logo or other artwork will be allowed for linking absent a trademark license
    agreement.</p>
<br>
<h3 id="iFrames"><strong>iFrames</strong></h3>
...
<br>
<h3 id="ContentLiability"><strong>Content Liability</strong></h3>
